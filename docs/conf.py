...
"""``discO`` documentation build configuration file.
...
the global ``discO`` configuration which is loaded here before anything else.
...
.. |RepresentationOrDifferential| replace:: :class:`~astropy.coordinates.BaseRepresentationOrDifferential`
.. |Representation| replace:: :class:`~astropy.coordinates.BaseRepresentation`
.. |Differential| replace:: :class:`~astropy.coordinates.BaseDifferential`

.. |CoordinateFrame| replace:: :class:`~astropy.coordinates.BaseCoordinateFrame`
.. |SkyCoord| replace:: :class:`~astropy.coordinates.SkyCoord`

.. |Model| replace:: :class:`~astropy.modeling.Model`
...
html_theme_options = {
    "logotext1": "discO",  # white,  semi-bold
