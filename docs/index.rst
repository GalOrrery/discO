###########################
`disk_expand` Documentation
###########################

This is the documentation for disk_expand.

All code and data is available on a `public repository on GitHub <https://github.com/nstarman/disk_expand>`_ so if you have any trouble, `open an issue <https://github.com/nstarman/disk_expand/issues>`_ there.
